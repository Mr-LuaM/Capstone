      ...
      >
        ...
        <v-list density="comfortable" nav>
          <v-list-item
            ...
            :class="{ highlight: isRouteActive('/station/dashboard') }"
          ...
          <v-list-item
            link
            to="/station/students"
            :class="{ highlight: isRouteActive('/station/students') }"
          ...
          <v-list-item
            link
            to="/station/teachers"
            :class="{ highlight: isRouteActive('/station/teachers') }"
          ...
          <v-list-item
            link
            to="/station/stations"
            :class="{ highlight: isRouteActive('/station/stations') }"
          ...
          <v-list-item
            link
            to="/station/announcements"
            :class="{ highlight: isRouteActive('/station/announcements') }"
          ...
          <v-list-item
            link
            to="/station/edit-accounts"
            :class="{ highlight: isRouteActive('/station/edit-accounts') }"
