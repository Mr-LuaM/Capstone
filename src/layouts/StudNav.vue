      ...
      >
        ...
        <v-list density="comfortable" nav>
          <v-list-item
            ...
            :class="{ highlight: isRouteActive('/student/dashboard') }"
          ...
          <v-list-item
            ...
            :class="{ highlight: isRouteActive('/student/announcements') }"
          ...
          <v-list-item
            link
            to="/student/edit-accounts"
            :class="{ highlight: isRouteActive('/student/edit-accounts') }"
