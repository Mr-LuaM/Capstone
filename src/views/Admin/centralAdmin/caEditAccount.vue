  ...
  methods: {
    ...
    async loadData() {
      try {
        ...
        const UserDetails = await axios.post("getAdminEditDetails", {
          userId,
          userRole,
          secureToken,
        });
    ...
    async save() {
      try {
        ...
        formData.append("userId", this.UserDetails.MainAdmin_ID);
        ...
        const response = await axios.post("updateMainAdminDetails", formData);
